...
(function () {
    ...
    var femaleFirstNames = ['Sophia', 'Emma', 'Isabella', 'Olivia', 'Ava', 'Emily', 'Abigail', 'Mia', 'Madison', 'Elizabeth', 'Chloe', 'Ella', 'Avery', 'Addison', 'Aubrey', 'Lily', 'Natalie', 'Sofia', 'Jordan', 'Charlotte', 'Zoey', 'Cameron', 'Grace', 'Hannah', 'Amelia', 'Lillian', 'Samantha', 'Evelyn', 'Victoria', 'Brooklyn', 'Zoe', 'Layla', 'Ayden', 'Hailey', 'Leah', 'Kaylee', 'Anna', 'Aaliyah', 'Gabriella', 'Allison', 'Nevaeh', 'Alexis', 'Audrey', 'Savannah', 'Sarah', 'Alyssa', 'Claire', 'Taylor', 'Camila', 'Arianna', 'Ashley', 'Brianna', 'Carson', 'Sophie', 'Bella', 'Khloe', 'Genesis', 'Alexa', 'Serenity', 'Kylie', 'Aubree', 'Scarlett', 'Stella', 'Maya', 'Katherine', 'Julia', 'Kayden', 'Ryder', 'Lucy', 'Madelyn', 'Autumn', 'Makayla', 'Kayla', 'Mackenzie', 'Lauren', 'Gianna', 'Ariana', 'Hayden', 'Faith', 'Alexandra', 'Melanie', 'Sydney', 'Bailey', 'Caroline', 'Naomi', 'Morgan', 'Kennedy', 'Ellie', 'Jasmine', 'Eva', 'Skylar', 'Kimberly', 'Violet', 'Molly', 'Aria', 'Jocelyn', 'Trinity', 'London', 'Lydia', 'Madeline', 'Reagan', 'Piper', 'Andrea', 'Annabelle', 'Maria', 'Brooke', 'Kaden', 'Payton', 'Paisley', 'Paige', 'Ruby', 'Nora', 'Mariah', 'Rylee', 'Lilly', 'Brielle', 'Gael', 'Jade', 'Destiny', 'Kaiden', 'Nicole', 'Mila', 'Kendall', 'Liliana', 'Kaitlyn', 'Natalia', 'Sadie', 'Jordyn', 'Vanessa', 'Mary', 'Mya', 'Penelope', 'Isabelle', 'Alice', 'Reese', 'Gabrielle', 'Katelyn', 'Angelina', 'Rachel', 'Isabel', 'Eleanor', 'Cayden', 'Clara', 'Brooklynn', 'Jessica', 'Maddox', 'Elena', 'Aliyah', 'Vivian', 'Laila', 'Sara', 'Amy', 'Eliana', 'Lyla', 'Juliana', 'Valeria', 'Adriana', 'Makenzie', 'Elise', 'Mckenzie', 'Delilah', 'Cora', 'Kylee', 'Avery', 'Rebecca', 'Gracie', 'Izabella', 'Kai', 'Josephine', 'Alaina', 'Michelle', 'Jennifer', 'Eden', 'Valentina', 'Aurora', 'Catherine', 'Stephanie', 'Valerie', 'Jayla', 'Willow', 'Daisy', 'Alana', 'Melody', 'Hazel', 'Summer', 'Melissa', 'Margaret', 'Ariel', 'Lila', 'Giselle', 'Ryleigh', 'Haley', 'Julianna', 'Ivy', 'Alivia', 'Brynn', 'Keira', 'Daniela', 'Aniyah', 'Angela', 'Kate', 'Londyn', 'Hayden', 'Harmony', 'Adalyn', 'Alexis', 'Megan', 'Allie', 'Gabriela', 'Alayna', 'Jenna', 'Alexandria', 'Ashlyn', 'Adrianna', 'Jada', 'Fiona', 'Norah', 'Maci', 'Miranda', 'Keegan', 'Ximena', 'Amaya', 'Cecilia', 'Ana', 'Katie', 'Hope', 'Callie', 'Jordan', 'Luna', 'Leilani', 'Eliza', 'Mckenna', 'Genevieve', 'Makenna', 'Isla', 'Lola', 'Danielle', 'Chelsea', 'Leila', 'Tessa', 'Adelyn', 'Camille', 'Mikayla', 'Adeline', 'Adalynn', 'Sienna', 'Esther', 'Jacqueline', 'Arabella', 'Maggie', 'Athena', 'Lucia', 'Lexi', 'Ayla'];
	var maleFirstNames = ['Jacob', 'Mason', 'Ethan', 'Noah', 'William', 'Liam', 'Jayden', 'Michael', 'Alexander', 'Aiden', 'Daniel', 'Matthew', 'Elijah', 'James', 'Anthony', 'Benjamin', 'Joshua', 'Andrew', 'David', 'Joseph', 'Logan', 'Jackson', 'Christopher', 'Gabriel', 'Samuel', 'Ryan', 'Lucas', 'John', 'Nathan', 'Isaac', 'Dylan', 'Caleb', 'Christian', 'Landon', 'Jonathan', 'Carter', 'Luke', 'Owen', 'Brayden', 'Gavin', 'Wyatt', 'Isaiah', 'Henry', 'Eli', 'Hunter', 'Jack', 'Evan', 'Nicholas', 'Tyler', 'Aaron', 'Jeremiah', 'Julian', 'Harper', 'Levi', 'Brandon', 'Angel', 'Austin', 'Connor', 'Adrian', 'Robert', 'Charles', 'Thomas', 'Sebastian', 'Colton', 'Jaxon', 'Kevin', 'Zachary', 'Dominic', 'Blake', 'Jose', 'Oliver', 'Justin', 'Bentley', 'Jason', 'Chase', 'Ian', 'Josiah', 'Parker', 'Xavier', 'Adam', 'Cooper', 'Riley', 'Nathaniel', 'Grayson', 'Jace', 'Peyton', 'Nolan', 'Tristan', 'Luis', 'Brody', 'Juan', 'Hudson', 'Bryson', 'Carlos', 'Easton', 'Damian', 'Alex', 'Jesus', 'Cole', 'Micah', 'Vincent', 'Max', 'Jaxson', 'Eric', 'Asher', 'Diego', 'Miles', 'Steven', 'Ivan', 'Elias', 'Aidan', 'Maxwell', 'Bryce', 'Antonio', 'Giovanni', 'Timothy', 'Bryan', 'Santiago', 'Colin', 'Richard', 'Braxton', 'Kaleb', 'Kyle', 'Preston', 'Miguel', 'Jonah', 'Lincoln', 'Riley', 'Leo', 'Victor', 'Brady', 'Jeremy', 'Mateo', 'Brian', 'Jaden', 'Ashton', 'Patrick', 'Declan', 'Sean', 'Joel', 'Sawyer', 'Alejandro', 'Marcus', 'Leonardo', 'Jesse', 'Caden', 'Jake', 'Wesley', 'Camden', 'Edward', 'Brantley', 'Roman', 'Axel', 'Silas', 'Jude', 'Grant', 'Hadley', 'Emmanuel', 'George', 'Malachi', 'Bradley', 'Alan', 'Weston', 'Gage', 'Devin', 'Greyson', 'Kenneth', 'Mark', 'Oscar', 'Tanner', 'Rylan', 'Nicolas', 'Harrison', 'Derek', 'Quinn', 'Peyton', 'Ezra', 'Tucker', 'Emmett', 'Cody', 'Calvin', 'Andres', 'Jorge', 'Abel', 'Paul', 'Abraham', 'Collin', 'Theodore', 'Ezekiel', 'Omar', 'Jayce', 'Conner', 'Bennett', 'Trevor', 'Eduardo', 'Peter', 'Maximus', 'Jaiden', 'Jameson', 'Seth', 'Kingston', 'Javier', 'Travis', 'Kinsley', 'Kinley', 'Garrett', 'Everett', 'Graham', 'Xander', 'Cristian', 'Damien', 'Ryker', 'Griffin', 'Corbin', 'Myles', 'Luca', 'Zane', 'Francisco', 'Ricardo', 'Stephen', 'Zayden', 'Iker', 'Drake', 'Lukas', 'Presley', 'Charlie', 'Spencer', 'Zion', 'Erick', 'Josue', 'Jeffrey', 'Trenton', 'Chance', 'Paxton', 'Elliot', 'Emery', 'Fernando', 'Landen', 'Manuel', 'Amir', 'Shane', 'Raymond', 'Andre', 'Shelby', 'Angel', 'Emerson'];
	
    Chance.prototype.first = function (gender) {
     	if (typeof gender === 'undefined') {
       		return this.pick(firstNames);
       	}
        else {
	    	if (gender === 'Male') {
	        	return this.pick(maleFirstNames);
	        }
	        else {
	        	return this.pick(femaleFirstNames);
	        }    	
        }
    };

    Chance.prototype.middle = function (gender) {
    	if (typeof gender === 'undefined') {
        	return this.pick(firstNames);
        }
        else {
    ...
    Chance.prototype.gender = function (name) {
    	if (typeof name === 'undefined') {
	        return this.pick(['Male', 'Female']);
    	}
    	else {
    		return (femaleFirstNames.indexOf(name) === -1 ? 'Male' : 'Female');
	    }
    };
